function contactsController($scope, $http) {
    ...
    $scope.url = "/sishadepro/protected/access_menu/";
    ...
    $scope.populateTable = function (data) {
        if (data.pagesCount > 0) {
            ...
            $scope.page = {source: data.aksesmenu, currentPage: $scope.pageToGet, pagesCount: data.pagesCount, totalContacts : data.totalAksesMenu};
