function proyeksController($scope, $http) {
    ...
    $scope.url = "/"+app+"/protected/master/proyeks/";
    ...
    $scope.populateTable = function (data) {
        if (data.pagesCount > 0) {
            ...
            $scope.page = {source: data.proyeks, currentPage: $scope.pageToGet, pagesCount: data.pagesCount, totalContacts : data.totalProyeks};
   ...
   $scope.selectedContact = function (contact) {
    ...
    $scope.createContact = function (newContactForm) {
        ...
        $http.post(url, $.param($scope.contact), config)
            .success(function (data) {
                $scope.finishAjaxCallOnSuccess(data, "#addProyekModal", false);               
            })
...
$scope.addSearchParametersIfNeeded = function(config, isPagination) {
    ...
    $scope.updateContact = function (updateContactForm) {
        ...
        var url = $scope.url + $scope.contact.id_proyek;
