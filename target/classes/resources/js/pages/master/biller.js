function billersController($scope, $http) {
    $scope.pageToGet = 0;
    ...
    $scope.url = "/tranmon/protected/master/billers/";
    ...
    $scope.populateTable = function (data) {
        if (data.pagesCount > 0) {
            ...
            $scope.page = {source: data.billers, currentPage: $scope.pageToGet, pagesCount: data.pagesCount, totalContacts : data.totalBillers};
