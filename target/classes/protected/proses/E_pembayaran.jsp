...
<div class="content-wrapper2">
    ...
    <section class="content content-header" ng-controller="pembayaransController">
        ...
        <div class="row">
            <div class="col-md-6">                       
                <jsp:include page="dialog_pembayaran/info_bayar_konsumen.jsp"/>                    
            </div>
            <div class="col-md-6">
                <jsp:include page="dialog_pembayaran/info_bayar_perumahan.jsp"/>                     
            </div>
        </div>
                ...
                <div class="box">
                    ...
                    <div class="form-horizontal">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                	<jsp:include page="dialog_pembayaran/info_bayar_angsuran.jsp"/>  
                                </div>
                                <div class="col-md-6">
                                   <jsp:include page="dialog_pembayaran/input_bayar.jsp"/>  
    ...
    <script src="<c:url value="/resources/js/pages/proses/pembayaran.js" />"></script>
