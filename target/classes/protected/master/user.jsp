...
<div class="content-wrapper">
    ...
    <section class="content ">
        <div class="box"  ng-controller="usersController">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr ng-repeat="contact in page.source">
                            	<td class="tdContactsCentered">{{contact.userid}}</td>
                                <td class="tdContactsCentered">{{contact.name}}</td>
                                <td class="tdContactsCentered">{{contact.password}}</td>
                                <td class="tdContactsCentered">{{contact.role_desciption}}</td>
                                <td class="width15">
    ...
    <!-- /.content -->
    <script src="<c:url value="/resources/js/pages/master/users.js" />"></script>
</div>
<!-- /.content-wrapper -->