...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Kelola Data Developer           
        </h1>
    </section>

    <!-- Main content -->
    <section class="content ">
        <div class="box"  ng-controller="developersController">
            ...
            <div class="box-body">
                ...
                <div id="gridContainer" ng-class="{'': state == 'list', 'none': state != 'list'}">  
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr ng-repeat="contact in page.source">
                                ...
                                <td class="tdContactsCentered">{{contact.npwp}}</td>
                                <td class="tdContactsCentered">{{contact.notelp}}</td>
                                <td class="width15">
                    ...
                    <jsp:include page="dialogs/developerDialogs.jsp"/>      
                </div>
    ...
    <!-- /.content -->
    <script src="<c:url value="/resources/js/pages/master/developers.js" />"></script>
</div>
<!-- /.content-wrapper -->