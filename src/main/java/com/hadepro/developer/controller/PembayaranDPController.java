...
@Controller
@RequestMapping(value = "/protected/proses/pembayarans_dp")
public class PembayaranDPController {
    ...
    public ModelAndView welcome(HttpSession session) {
    	ModelAndView model = new ModelAndView("bayarDPsList");
    	return model;
    }
    ...
    private TransaksiListVO listAll(int page) {
    	...
    	int lunas= 0;
      return localDB.getListTransaksiDP(lunas , page, maxResults);
    } 
    ...
    public ResponseEntity<?>  create(@ModelAttribute("transaksi") Pembayaran transaksi) throws SQLException,  ServletException, IOException,  ClassNotFoundException, JRException {
        ...
        int r = localDB.UpdateAngsuranDP(transaksi);
    ...
    private PembayaranListVO listAllBayar(int page) {
    	maxResults = localDB.getMaxResultPage("maxCountPage");
    	int lunas= 0;
      return localDB.getListPembayaranDP(page, maxResults);
    } 
