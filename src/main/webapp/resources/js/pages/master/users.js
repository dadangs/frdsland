function usersController($scope, $http) {
    ...
    $scope.url = "/"+app+"/protected/master/users/";
    ...
    $scope.populateTable = function (data) {
        if (data.pagesCount > 0) {
            ...
            $scope.page = {source: data.user, currentPage: $scope.pageToGet, pagesCount: data.pagesCount, totalContacts : data.totalUser};
