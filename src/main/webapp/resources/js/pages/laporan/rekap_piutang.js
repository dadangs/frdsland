function rekap_piutangsController($scope, $http) {
    ...
    $scope.url = "/"+app+"/protected/laporan/rekap_piutangs/";
    ...
    $scope.populateTable = function (data) {
        if (data.pagesCount > 0) {
            ...
            $scope.page = {source: data.rekap_piutangs, currentPage: $scope.pageToGet, pagesCount: data.pagesCount, totalContacts : data.totalRekaps};
